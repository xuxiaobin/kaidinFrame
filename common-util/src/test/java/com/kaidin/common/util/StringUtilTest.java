...
public class StringUtilTest {
	...
	public void testToUpperCase() {
		...
		assertEquals(StringUtil.EMPTY_STR, StringUtil.toUpperCase(""));
	...
	public void testToLowerCase() {
		...
		assertEquals(StringUtil.EMPTY_STR, StringUtil.toLowerCase(""));
	...
	public void testUpperCase2Underline() {
		...
		assertEquals(StringUtil.EMPTY_STR, StringUtil.upperCase2Underline(""));
	...
	public void testUnderline2UpperCase() {
		...
		assertEquals(StringUtil.EMPTY_STR, StringUtil.underline2UpperCase(""));
	...
	public void testSubstring() {
		...
		assertEquals(StringUtil.EMPTY_STR, StringUtil.subString("", 1, 2));
