package com.kaidin.appframe.dao.ejb.impl;
...
import com.kaidin.appframe.dao.ejb.interfaces.IDaoContext;
...
//	}
	...
	public BaseDaoImpl(String jndiName, Class<T> clazz, IDaoContext aDaoContext) throws AppframeException {
		entityClass = clazz;
		entityClassName = clazz.getName();
		// if (!ServiceFactory.isEjb()) {
		// if (null != entityManager) {
